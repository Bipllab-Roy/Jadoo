const ServiceCard = ({ service }) => {
  return (
    <div className=" relative z-[1] after:absolute hover:after:transition-all after:content-[''] after:bottom-[-35px] after:w-[100px] after:h-[100px] after:left-[-40px]  after:bg-transparent after:-z-[1] after:rounded-tl-[30px] after:rounded-br-[10px] hover:after:bg-orange">
