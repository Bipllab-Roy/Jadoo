const DestinationCard = ({ destination }) => {
  const { icon, place, price, day } = destination;
  return (
    <div className="rounded-3xl overflow-hidden destinationShadow w-[330px] ">
      <div className="h-[330px]  overflow-hidden">
        <img className="size-full" src={icon} alt="icon" />
      </div>
      <div className="pt-8 px-5 pb-10.5 bg-white">
